# Kroll Database Schema

from sqlalchemy import (
    create_engine, Column, Integer, String, Boolean, DateTime, CHAR, Text,
    SmallInteger, ForeignKey, Numeric, Enum, LargeBinary, UniqueConstraint
)
...
# Kroll Tables
class KrollDoctor(Base):
    __tablename__ = 'kroll_doctor'
    id = Column(Integer, primary_key=True, index=True, nullable=False, unique=True, autoincrement=True)
    Code = Column(CHAR, nullable=True)
    LastName = Column(String, nullable=False)
    FirstName = Column(String, nullable=False)
    Salutation = Column(String, nullable=True)
    Designation = Column(Integer, nullable=False)
    Specialty = Column(String, nullable=True)
    Prov1 = Column(CHAR, nullable=False)
    Ref1 = Column(CHAR, nullable=True)
    RefUE1 = Column(Boolean, nullable=True)
    Licence1 = Column(String, nullable=True)
    Prov2 = Column(CHAR, nullable=True)
    Ref2 = Column(CHAR, nullable=True)
    RefUE2 = Column(Boolean, nullable=True)
    Licence2 = Column(String, nullable=True)
    Comment = Column(Text, nullable=True)
    Email = Column(String, index=True)
    Created = Column(DateTime, nullable=True)
    Changed = Column(DateTime, nullable=True)
    Purge = Column(DateTime, nullable=True)
    LastUsed = Column(DateTime, nullable=True)
    DispensingRights = Column(SmallInteger, nullable=True)
    NoKrollCare = Column(Boolean, nullable=True)
    NoFaxRefills = Column(Boolean, nullable=True)
    Language = Column(CHAR, nullable=True)
    NoPhoneRefills = Column(Boolean, nullable=True)
    Active = Column(Boolean, nullable=False)
    MergedToId = Column(Integer, nullable=True)
    LanguageSpoken = Column(String, nullable=True)
    NoMedReviewLetter = Column(Boolean, nullable=True)
...
class KrollSigPosology(Base):
    __tablename__ = 'kroll_sig_posology'
    id = Column(Integer, primary_key=True, index=True, nullable=False, unique=True, autoincrement=True)
    Language = Column(String, nullable=False)                           #varchar11
    Token = Column(String, index=True, nullable=False)     #varchar10
    Text = Column(String, nullable=True)                                #nvarchar300
    QtyLow = Column(Numeric(precision=10, scale=2), nullable=True)      #numeric(11,3)
    QtyHigh = Column(Numeric(precision=10, scale=2), nullable=True)     #numeric(11,3)
    FrequencyNumerator = Column(Integer, nullable=True)                 #int
    FrequencyDenominator1 = Column(Integer, nullable=True)              #int
    FrequencyDenominator2 = Column(Integer, nullable=True)              #int
    FrequencyDenominatorUnits = Column(String, nullable=True)           #varchar200
    Duration = Column(Integer, nullable=True)                           #int
    IsCondition = Column(Boolean, nullable=True)                        #bit
    Condition = Column(String, nullable=True)                           #varchar200
    IsSupplementalInstruction = Column(Boolean, nullable=True)          #bit
    SupplementalInstruction = Column(String, nullable=True)             #varchar200
    IsRouteOfAdmin = Column(Boolean, nullable=True)                     #bit
    IsMaxDosage = Column(Boolean, nullable=True)                        #bit
    MaxDoseQty = Column(Integer, nullable=True)                         #int
    MaxDoseQtyUnit = Column(String, nullable=True)                      #varchar20
    MaxDoseRange = Column(Integer, nullable=True)                       #int
    MaxDoseRangeUnit = Column(String, nullable=True)                    #varchar20
    createdAt = Column(DateTime)
    updatedAt = Column(DateTime)

    __table_args__ = (
        UniqueConstraint('Language', 'Token', name='uq_kroll_sig_posology_language_token'),
    )

class KrollICD10CA(Base):
    __tablename__ = 'kroll_icd10ca_mast'
    ICD10CA = Column(String, primary_key=True, nullable=False, unique=True)
    Description = Column(String, nullable=False)                        #varchar255
    ShortDescription = Column(String, nullable=False)                   #varchar40
    ICD10CAType = Column(String, nullable=False)                        #varchar2
    IsFDBDDCScreened = Column(Boolean, nullable=False)                  #bit
    createdAt = Column(DateTime)
    updatedAt = Column(DateTime)

class KrollMedCondition(Base):
    __tablename__ = 'kroll_med_condition'
    Fdbdx = Column(String, primary_key=True, nullable=False, unique=True)
    FdbdxDesc = Column(String, nullable=False)                          #varchar56
    IsFDBDDCScreened = Column(Boolean, nullable=False)                  #bit
    DxId = Column(Integer, nullable=False)                             #int
    DxIdStatus = Column(String, nullable=False)                       #varchar1
    DxIdDiseaseDurationCode = Column(String, nullable=False)          #varchar1
    createdAt = Column(DateTime)
    updatedAt = Column(DateTime)